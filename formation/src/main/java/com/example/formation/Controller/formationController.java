...
import com.example.formation.Services.IformationService;
...
public class formationController {
    ...
    @PostMapping(path = "/ajouterFormation/{idcategorie}/{NomFomation}/{prix}/{duree}" ,consumes = {MULTIPART_FORM_DATA_VALUE  })
